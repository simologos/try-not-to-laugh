 ...
 */
export const addVideo: ICommandCreator<IVideo> =
  commandCreator<IVideo>('ADD_VIDEO');

/**
 * Command to update an existing video in a users library.
 */
export const updateVideo: ICommandCreator<IVideo & IIdentifier> =
  commandCreator<IVideo & IIdentifier>('UPDATE_VIDEO');

/**
 * Command to remove an existing video from a users library.
 */
export const removeVideo: ICommandCreator<IIdentifier> =
  commandCreator<IIdentifier>('REMOVE_VIDEO');